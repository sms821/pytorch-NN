...
class MobileNet_trimmed5(nn.Module):
    def __init__(self):
        super(MobileNet_trimmed5, self).__init__()
        ...
        # dw-conv-2 (stride=2)
        self.conv4 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=2, padding=1, groups=4, bias=False)
        ...
        # dw-conv-4 (stride=2)
        self.conv8 = nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=2, padding=1, groups=16, bias=False)
        ...
        # dw-conv-6 (stride=2)
        self.conv12 = nn.Conv2d(in_channels=1024, out_channels=1024, kernel_size=3, stride=2, padding=1, groups=64, bias=False)
